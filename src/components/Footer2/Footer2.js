    ...
    <div className="footer-container2">
      <div className="footer-items-container">
        <div className="footer-section">
          <ul>
            <li>
              <a href="tel:2310 624577">
                <p>
                  <FaPhone /> 231 062 4577
                </p>
              </a>
            </li>
            <li>
        ...
        <div className="footer-section" id="socials">
          <ul>
            <li>
              <a className="a-row" href="https://www.instagram.com/fightclubtalos/?hl=el" target="_blank" rel="noreferrer">
                <p>Ακολούθησε μας στο Instagram</p>
                <img src={insta} className="logos" alt="instagram" width={"30"} />
              </a>
            </li>
            <li>
              <a className="a-row" href="https://www.facebook.com/FightClubTalos/" target="_blank" rel="noreferrer">
